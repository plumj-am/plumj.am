...
The big thing holding me back from switching to Linux as a daily driver has been
gaming. I've long been under the impression that Linux is terrible for it, and
despite playing fewer and fewer games, I was never willing to fully give it up.
...
day, my WSL crashed and I was told that the VHD was corrupted. Thanks to version
control, only about two hours of work was lost, but it was yet another nail in
the MS coffin.
...
- Graphics drivers are a breeze and can be handled declaratively in a
  [few lines of configuration](https://github.com/plumj-am/nixos/blob/master/modules/linux/games.nix).
  (No manual driver hunting or hacky workarounds!)
- Personally, I've only had positive experiences with other NixOS users. I am
  aware that parts of the community have a poor reputation for a number of
...
There was a large learning curve and things like dynamic binaries were a pain
until I found [nix-ld](https://github.com/nix-community/nix-ld).
...
[NixOS configurations](https://github.com/RGBCube/ncc) as a reference for my own
once I realised I needed a more complex setup for all my hosts.

---

## Related content

My NixOS configurations: [GitHub](https://github.com/plumj-am/nixos),
[Forgejo](https://git.plumj.am/plumjam/nixos).
...
- Reword closing thoughts about the learning curve.
- My configurations now follow a dendritic approach so some of the content of
  this post may not align with what you see on my repo.
